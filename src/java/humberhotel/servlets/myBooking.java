    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                String query = "Select a.roomnumber, b.bdate from n00770693.hotelbookings a "
                        + "join n00770693.hotelbookeddays b on a.id = b.bookingid "
                        + "join n00770693.hotelusers c on a.bookedby = c.email"
                        + "where c.name = '" + user.getName() + "'";
